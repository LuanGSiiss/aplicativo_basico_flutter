      ...
      home: Scaffold(
        ...
        body: const SingleChildScrollView(
          child: Column(
            children: [
              ImageSection(
                image: 'images/flutter_icon.png',
              ),
              TitleSection(
                name: 'Atividade 09 - Flutter',
                location: 'UNIDAVI, Rio do Sul - SC',
              ),
              ButtonSection(),
              TextSection(
                description:
...
class _ExpandableFabState extends State<ExpandableFab>
  ...
  List<Widget> _buildExpandingActionButtons() {
    ...
    // Se só tiver 1 filho, não divide por zero
    final step = count > 1 ? 90.0 / (count - 1) : 90.0;

    for (var i = 0; i < count; i++) {
      final angleInDegrees = i * step;
      children.add(
      ...
      builder: (context, child) {
        ...
        return Positioned(
          ...
          child: Transform.scale(
            scale: progress.value, // escala de 0 → 1
            child: Opacity(
